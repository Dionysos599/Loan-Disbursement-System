...
const PortfolioDashboard: React.FC<PortfolioDashboardProps> = ({ batchId, open, onClose }) => {
  ...
  }, [open, batchId, loadDashboardData]);
  ...
  const processPortfolioData = (forecastData: LoanForecastData[]) => {
    ...
    return {
      ...
      propertyTypeData: loanNumberData, // Renamed to propertyTypeData for compatibility
      cityData: loanNumberData, // Renamed to cityData for compatibility
    };
  };
